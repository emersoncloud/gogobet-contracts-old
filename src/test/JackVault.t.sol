...
import {JackVault} from "../JackVault.sol";
import {ECoin} from "../ECoin.sol";

contract JackVaultTest is Test {
    ECoin underlying;
    JackVault vault;

    function setUp() public {
        underlying = new ECoin();
        vault = new JackVault(underlying, "Jack Vault", "JV");
    }
    ...
    function testMetadata(string calldata name, string calldata symbol) public {
        JackVault vlt = new JackVault(underlying, name, symbol);
    ...
    function testSingleDepositWithdraw(uint128 amount) public {
        ...
        assertEq(vault.afterDepositCounter(), 1);
        ...
        assertEq(vault.beforeWithdrawCounter(), 1);
    ...
    function testMultipleMintDepositRedeemWithdraw() public {
        ...
        assertEq(vault.afterDepositCounter(), 2);
